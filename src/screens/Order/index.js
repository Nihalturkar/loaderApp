...
import { GetOrderApi, GetSingleOrderApi } from '../../redux/actions/orderAction'
...
const Order = ({ navigation, GetOrderApi, orderData, manuallyModal, loading, GetSingleOrderApi }) => {
                        ...
                        <FlatList
                            ...
                            onEndReached={() => {
                                if (orderData.length >= 20) {
                                    GetOrderApi(page + 1, status, (data) => setDownLoading(data))
                                    setPage(page + 1)
